...
import { View, Text,TextInput,FlatList, StyleSheet,SafeAreaView,TouchableOpacity,ActivityIndicator,BackHandler,Modal} from 'react-native'
...
import DatePicker from 'react-native-datepicker'
  ...
  const RoundTrip = () => {
    ...
    const [selectedArrival,setSelectedArrival]=useState('Choose departure : ');
